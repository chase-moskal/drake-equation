...
},{"mobx":2,"preact":3}],2:[function(require,module,exports){
...
"use strict";var __extends=this&&this.__extends||function(){var e=function(t,r){return(e=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(e,t){e.__proto__=t}||function(e,t){for(var r in t)t.hasOwnProperty(r)&&(e[r]=t[r])})(t,r)};return function(t,r){function a(){this.constructor=t}e(t,r),t.prototype=null===r?Object.create(r):(a.prototype=r.prototype,new a)}}(),__assign=this&&this.__assign||function(){return(__assign=Object.assign||function(e){for(var t,r=1,a=arguments.length;r<a;r++)for(var i in t=arguments[r])Object.prototype.hasOwnProperty.call(t,i)&&(e[i]=t[i]);return e}).apply(this,arguments)},__decorate=this&&this.__decorate||function(e,t,r,a){var i,n=arguments.length,s=n<3?t:null===a?a=Object.getOwnPropertyDescriptor(t,r):a;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,r,a);else for(var c=e.length-1;c>=0;c--)(i=e[c])&&(s=(n<3?i(s):n>3?i(t,r,s):i(t,r))||s);return n>3&&s&&Object.defineProperty(t,r,s),s};Object.defineProperty(exports,"__esModule",{value:!0});var mobx_1=require("mobx"),preact_1=require("preact"),mobx_preact_1=require("mobx-preact");function formatDecimalsDynamically(e){return 0===e?e.toFixed(0):e<1?e.toFixed(2):e<100?e.toFixed(1):e.toFixed(0)}var zeroize=function(e){return 0===e?{"data-zero":!0}:{}},Equation=function(e){function t(){return null!==e&&e.apply(this,arguments)||this}return __extends(t,e),t.prototype.prepEventHandlers=function(e){var t=this,r=function(r){var a=t.props.store,i=r.currentTarget.value,n=parseFloat(i);mobx_1.runInAction(function(){a[e]=n})};return{onChange:r,onKeyUp:r,onClick:r}},t.prototype.render=function(){var e=this.props.store;return preact_1.h("div",{className:"equation"},preact_1.h("div",{class:"equation-term","data-term":"n"},preact_1.h("div",{class:"term-name"},"N"),preact_1.h("div",{class:"term-definition"},"Number of civilizations in the Milky Way"),preact_1.h("div",{class:"term-interactive"},preact_1.h("output",__assign({},zeroize(e.n)),formatDecimalsDynamically(e.n)))),preact_1.h("div",{class:"equation-term"},preact_1.h("div",{class:"term-name"},"="),preact_1.h("div",{class:"term-definition"}),preact_1.h("div",{class:"term-interactive"})),preact_1.h("div",{class:"equation-term","data-term":"r"},preact_1.h("div",{class:"term-name"},"R",preact_1.h("sub",null,"*")),preact_1.h("div",{class:"term-definition"},"Rate of star formation"),preact_1.h("div",{class:"term-interactive"},preact_1.h("input",__assign({type:"number",min:"0",value:e.r},zeroize(e.r),this.prepEventHandlers("r"))))),preact_1.h("div",{class:"equation-term"},preact_1.h("div",{class:"term-name"},"F",preact_1.h("sub",null,"p")),preact_1.h("div",{class:"term-definition"},"Fraction of stars with planets"),preact_1.h("div",{class:"term-interactive"},preact_1.h("input",__assign({type:"number",min:"0",max:"1",step:"0.1",value:e.fp},zeroize(e.fp),this.prepEventHandlers("fp"))))),preact_1.h("div",{class:"equation-term"},preact_1.h("div",{class:"term-name"},"N",preact_1.h("sub",null,"e")),preact_1.h("div",{class:"term-definition"},"Number of habitable planets per planetary system"),preact_1.h("div",{class:"term-interactive"},preact_1.h("input",__assign({type:"number",min:"0",step:"0.25",value:e.ne},zeroize(e.ne),this.prepEventHandlers("ne"))))),preact_1.h("div",{class:"equation-term"},preact_1.h("div",{class:"term-name"},"F",preact_1.h("sub",null,"l")),preact_1.h("div",{class:"term-definition"},"Fraction of habitable planets which develop life"),preact_1.h("div",{class:"term-interactive"},preact_1.h("input",__assign({type:"number",min:"0",max:"1",step:"0.1",value:e.fl},zeroize(e.fl),this.prepEventHandlers("fl"))))),preact_1.h("div",{class:"equation-term"},preact_1.h("div",{class:"term-name"},"F",preact_1.h("sub",null,"i")),preact_1.h("div",{class:"term-definition"},"Fraction of life which becomes intelligent"),preact_1.h("div",{class:"term-interactive"},preact_1.h("input",__assign({type:"number",min:"0",max:"1",step:"0.1",value:e.fi},zeroize(e.fi),this.prepEventHandlers("fi"))))),preact_1.h("div",{class:"equation-term"},preact_1.h("div",{class:"term-name"},"F",preact_1.h("sub",null,"c")),preact_1.h("div",{class:"term-definition"},"Fraction of intelligence which is communicative"),preact_1.h("div",{class:"term-interactive"},preact_1.h("input",__assign({type:"number",min:"0",max:"1",step:"0.1",value:e.fc},zeroize(e.fc),this.prepEventHandlers("fc"))))),preact_1.h("div",{class:"equation-term"},preact_1.h("div",{class:"term-name"},"L"),preact_1.h("div",{class:"term-definition"},"Lifespan of civilization in years"),preact_1.h("div",{class:"term-interactive"},preact_1.h("input",__assign({type:"number",min:"0",value:e.l},zeroize(e.l),this.prepEventHandlers("l"))))))},t=__decorate([mobx_preact_1.observer],t)}(preact_1.Component);exports.Equation=Equation;

},{"mobx":2,"mobx-preact":1,"preact":3}],6:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var preact_1=require("preact"),equation_1=require("./components/equation"),equation_store_1=require("./stores/equation-store"),equationStore=new equation_store_1.EquationStore;preact_1.render(preact_1.h(equation_1.Equation,{store:equationStore}),document.querySelector(".preact-equation-area"));

},{"./components/equation":5,"./stores/equation-store":7,"preact":3}],7:[function(require,module,exports){
"use strict";var __decorate=this&&this.__decorate||function(e,o,t,r){var i,c=arguments.length,b=c<3?o:null===r?r=Object.getOwnPropertyDescriptor(o,t):r;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)b=Reflect.decorate(e,o,t,r);else for(var n=e.length-1;n>=0;n--)(i=e[n])&&(b=(c<3?i(b):c>3?i(o,t,b):i(o,t))||b);return c>3&&b&&Object.defineProperty(o,t,b),b};Object.defineProperty(exports,"__esModule",{value:!0});var mobx_1=require("mobx"),EquationStore=function(){function e(){this.r=1,this.fp=.2,this.ne=1,this.fl=1,this.fi=1,this.fc=.1,this.l=1e3}return Object.defineProperty(e.prototype,"n",{get:function(){var e=this;return e.r*e.fp*e.ne*e.fl*e.fi*e.fc*e.l},enumerable:!0,configurable:!0}),__decorate([mobx_1.observable],e.prototype,"r",void 0),__decorate([mobx_1.observable],e.prototype,"fp",void 0),__decorate([mobx_1.observable],e.prototype,"ne",void 0),__decorate([mobx_1.observable],e.prototype,"fl",void 0),__decorate([mobx_1.observable],e.prototype,"fi",void 0),__decorate([mobx_1.observable],e.prototype,"fc",void 0),__decorate([mobx_1.observable],e.prototype,"l",void 0),__decorate([mobx_1.computed],e.prototype,"n",null),e}();exports.EquationStore=EquationStore;
